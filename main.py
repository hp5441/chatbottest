...
def process_question(question: models.Question, match=""):
    ...
    print(question.is_keyword)
    if question.is_keyword:
        processed_question = "Related Info On : "+ processed_question
...
def process_answer(answer : models.Answer):
    ...
    if processed_answer[0]!="<" or processed_answer[-1]!=">":
        html = linkify("<p style='white-space: pre-line' >"+processed_answer+"</p>")
    else:
